...
class ActorNetwork(nn.Module):
    ...
    def __init__(self, D_obs, D_act):
        ...
        self.fc_h1 = nn.Linear(D_obs, 100)
        self.fc_h2 = nn.Linear(100, 100)
        self.fc_act = nn.Linear(100, D_act)
...
class CriticNetwork(nn.Module):
    ...
    def __init__(self, D_obs, D_act):
        ...
        self.fc_obs = nn.Linear(D_obs, 100)
        self.fc_act = nn.Linear(D_act, 100)
        # self.fc_h1 = nn.Linear(D_obs+D_act, 128)
        self.fc_h2 = nn.Linear(100, 100)
        self.fc_q = nn.Linear(100, 1)
