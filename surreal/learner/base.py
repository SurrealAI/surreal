...
class PrefetchBatchQueue(object):
    ...
    def _enqueue_loop(self):
        while True:
            ...
            sample = self.preprocess_batch_func(sample)
...
class LearnerCore(metaclass=LearnerMeta):
    def __init__(self, *,
        ...
        self._prefetch_queue = PrefetchBatchQueue(
            ...
            preprocess_batch_func=self.preprocess_batch,
        )
    ...
    def preprocess_batch(self, raw_batch):
        """
            batch is a list of experience generated by sender
            returns batch_exp used for learn method
            Defined separately to be called in the data fetching thread/process
        """
